#!/usr/bin/env python3
"""
Advanced Trainer for MIMIC-CXR Radiology Report Model with LLaVA-Med v1.5
Implements curriculum learning, class balancing, JSON drift prevention, and early stopping
Optimized for microsoft/llava-med-v1.5-mistral-7b model
"""
...
class AdvancedRadiologyTrainer:
    ...
    def setup_model_and_tokenizer(self):
        ...
        # Load LLaVA-Med v1.5 using the correct LLaVA model class
        try:
            # LLaVA-Med v1.5 uses LlavaMistralForCausalLM
            from llava.model.language_model.llava_mistral import LlavaMistralForCausalLM
